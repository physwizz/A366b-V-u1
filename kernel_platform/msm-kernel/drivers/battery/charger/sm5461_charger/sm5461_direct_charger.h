...
#define PRE_CC_RAMP_UP_LEV      4430
#define CC_ST_IBUS_OFFSET       100
#define CV_ST_SUB_DC_OFF_IBUS   1000
#define SM_DC_DUAL_CV_OFFSET    200
#define SM_DC_DUAL_CV_SUB_OFFS  40
#define SM_DC_IBUSUCP_OFF       0
#define SM_DC_IBUSUCP_ON        1
...
struct sm_dc_ops {
	...
	int (*set_dc_dual_cfg)(struct i2c_client *i2c, u32 cv_gl, u8 en_ucp);
};
