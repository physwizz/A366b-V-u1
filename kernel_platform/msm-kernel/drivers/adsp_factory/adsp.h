...
#ifdef CONFIG_AOIS_FACTORY
	struct notifier_block cam_ois_cmd_nb;
	struct notifier_block cam_ois_reg_read_nb;
	struct notifier_block cam_ois_factory_mode_nb;
#endif
...
#if IS_ENABLED(CONFIG_MXGX300_FACTORY)
int mxgx300_factory_init(void);
void mxgx300_factory_exit(void);
#endif
...
#if IS_ENABLED(CONFIG_AOIS_FACTORY)
