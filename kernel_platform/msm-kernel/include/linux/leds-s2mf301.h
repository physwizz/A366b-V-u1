...
extern ssize_t s2mf301_rear_flash_store(struct device *dev, struct device_attribute *attr, const char *buf, size_t size);
extern ssize_t s2mf301_rear_flash_show(struct device *dev, struct device_attribute *attr, char *buf);
extern int s2mf301_fled_set_mode_ctrl(int chan, enum cam_flash_mode cam_mode);
extern int s2mf301_fled_set_curr(int chan, enum cam_flash_mode cam_mode, int curr);
