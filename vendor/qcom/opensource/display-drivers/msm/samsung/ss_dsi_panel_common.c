			...
			for (i = 0; i < esd->num_of_gpio; i++) {
				...
				if (ss_gpio_is_valid(gpio)) {
					if (gpio_request(gpio, "esd_recovery")) {
						...
						ret = enable_irq_wake(ss_gpio_to_irq(gpio));
						if (ret < 0)
							LCD_ERR(vdd, "Failed to Enable Wakeup Source(%d)", ret);
						else
							LCD_INFO(vdd, "Success to enable irq wake\n");
					}
				} else {
...
#endif
#if IS_ENABLED(CONFIG_PANEL_Q7_S6E3XA5_AMF800LA01_QXGA)
	else if (!strncmp(panel_string, "Q7_S6E3XA5_AMF800LA01", strlen(panel_string)))
		vdd->panel_func.samsung_panel_init = Q7_S6E3XA5_AMF800LA01_QXGA_init;
#endif
#if IS_ENABLED(CONFIG_PANEL_Q7_S6E3FAE_AMB649GY02_HD)
	else if (!strncmp(panel_string, "Q7_S6E3FAE_AMB649GY02", strlen(panel_string)))
		vdd->panel_func.samsung_panel_init = Q7_S6E3FAE_AMB649GY02_HD_init;
#endif
#if IS_ENABLED(CONFIG_PANEL_Q7_S6E3XA5_AMF800LA01_VHM_QXGA)
	else if (!strncmp(panel_string, "Q7_S6E3XA5_AMF800LA01_VHM", strlen(panel_string)))
		vdd->panel_func.samsung_panel_init = Q7_S6E3XA5_AMF800LA01_VHM_QXGA_init;
#endif
#if IS_ENABLED(CONFIG_PANEL_Q7_S6E3FAE_AMB649GY02_VHM_HD)
	else if (!strncmp(panel_string, "Q7_S6E3FAE_AMB649GY02_VHM", strlen(panel_string)))
		vdd->panel_func.samsung_panel_init = Q7_S6E3FAE_AMB649GY02_VHM_HD_init;
#endif
...
#endif
#if IS_ENABLED(CONFIG_PANEL_Q7M_ANA38410_AMF996LC01_WQXGA)
	else if (!strncmp(panel_string, "Q7M_ANA38410_AMF996LC01", strlen(panel_string)))
		vdd->panel_func.samsung_panel_init = Q7M_ANA38410_AMF996LC01_WQXGA_init;
#endif
#if IS_ENABLED(CONFIG_PANEL_Q7M_S6E3FAE_AMB649LD01_HD)
	else if (!strncmp(panel_string, "Q7M_S6E3FAE_AMB649LD01", strlen(panel_string)))
		vdd->panel_func.samsung_panel_init = Q7M_S6E3FAE_AMB649LD01_HD_init;
#endif
