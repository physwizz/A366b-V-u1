...
{
	CAM_INFO(CAM_OIS, "cam_ois_i2c_driver_probe");
	int rc = 0;
...
#if defined(CONFIG_SAMSUNG_OIS_MCU_STM32)
#if defined(CONFIG_SEC_CAM_OIS_ALGO)
	register_vois_noti(&cam_ois_AOIS_Enable_notifier_register, &cam_ois_AOIS_Enable_notifier_unregister,
					&cam_ois_reg_read_notifier_register,&cam_ois_reg_read_notifier_unregister,
					&cam_ois_reg_write_notifier_register,&cam_ois_reg_write_notifier_unregister);
#endif
#endif
