...
struct cam_mipi_info {
	int32_t is_3phase;
	int32_t data_rate;
};

struct cam_sensor_adaptive_mipi_info {
	const struct cam_mipi_sensor_mode* (*get_adaptive_mipi_info) (struct cam_sensor_ctrl_t *s_ctrl, struct cam_mipi_info *mipi_info);
};
