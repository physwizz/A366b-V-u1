...
void cam_sensor_get_adaptive_mipi_info (struct cam_sensor_ctrl_t *s_ctrl)
{
	...
	if (sensor_id == SENSOR_ID_IMX882)
		s_ctrl->adaptive_mipi_info = imx882_adaptive_mipi_info;
	else if (sensor_id == SENSOR_ID_GC05A3)
		s_ctrl->adaptive_mipi_info = gc05a3_adaptive_mipi_info;
	else if (sensor_id == SENSOR_ID_GC08A3)
		s_ctrl->adaptive_mipi_info = gc08a3_adaptive_mipi_info;
	else if (sensor_id == SENSOR_ID_GC12A2)
		s_ctrl->adaptive_mipi_info = gc12a2_adaptive_mipi_info;
};
#endif
