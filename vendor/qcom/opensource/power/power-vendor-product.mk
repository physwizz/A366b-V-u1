...
ifneq ($(filter a36x%, $(TARGET_PRODUCT)),)
PRODUCT_COPY_FILES += vendor/qcom/opensource/power/config/parrot/powerhint_a36.xml:$(TARGET_COPY_OUT_VENDOR)/etc/powerhint.xml
else
